...
>>>>>>> origin/main
          <div className="text-left font-semibold">
            Developed by{" "}
            <a
              href="https://www.linkedin.com/in/vishalgunjal-"
              target="_blank"
              rel="noreferrer"
            >
<<<<<<< HEAD
=======
          {/* <div className="flex items-center">
            ...
            <a
              href="https://www.github.com/vivek-panchal"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://twitter.com/Vivekpanchaal"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="text-left font-semibold">
            Developed by{" "}
            <a href="https://vishalgunjalswe.vercel.app/" target="_blank">
>>>>>>> 400eb95 (Up)
=======
>>>>>>> origin/main
              Vishal D. Gunjal
